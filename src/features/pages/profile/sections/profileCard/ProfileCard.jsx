...
const ProfileCard = () => {
  const [showUpdateBioDetails, setShowUpdateBioDetails] = useState(false)

  const [] = useState()
  return (
    <section className={styles.profileCardSection}>
      {showUpdateBioDetails && <UpdateBioDetails setShowUpdateBioDetails={setShowUpdateBioDetails} />}
      <div className={styles.profileCardWrapper}>
        ...
        <header className={styles.profileCardHeader}>
            ...
            <div className={styles.profileBtnContainer}>
              <button 
                onClick={() => setShowUpdateBioDetails(true)}
