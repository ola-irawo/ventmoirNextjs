...
import styles from './mutedUserSetting.module.css';
import Image from 'next/image';

const MutedUserSetting = () => {
    ...
    <section className={styles.blockedUser}>
      <h2 className={styles.blockedUserTitle}>Muted accounts</h2>
...
export default MutedUserSetting;
