    ...
    <article className={styles.userCommentCardContainer}>
        ...
        >
            <Image
                ...
                width={45}
                height={45}
                className={styles.userProfileAvatarContainer}
                onClick={() => router.push("/profile")}
            />
            
            <div>
                <header className={styles.userCommentHeader}>
                    <div className={styles.usernameAndTimeContainer}>
                        <h2 
                            className={styles.userCommentName}
                            onClick={() => router.push("/profile")}
                        >{comment.user}</h2>
                        <time dateTime="" className={styles.commentTime}>11:12 AM</time>
                    </div>

                    <div>
                    <button 
                        className={styles.userCommentOptions}
                ...
                <div className={styles.commentInteractionContainer}>
                <UpvotePost />
                <DownvotePost />
                <PostComment />
                <Repost />
